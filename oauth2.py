...
def GeneratePermissionUrl(client_id, redirect_uri='urn:ietf:wg:oauth:2.0:oob', scope='https://mail.google.com/ https://www.googleapis.com/auth/userinfo.email'):
...
def AuthorizeTokens(client_id, client_secret, authorization_code, redirect_uri='urn:ietf:wg:oauth:2.0:oob'):
